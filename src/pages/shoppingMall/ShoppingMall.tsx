...
import { EmComponent } from "../../components/emComponent/EmComponent";
import{SmCarousel} from "../../components/smCarousel/SmCarousel"


export const ShoppingMall: React.FC = () => {
  //useSelector作用：共享状态,从Redux的store中提取数据（state）const num=useSelector(state=>state.num)
  ...
  //html: <div id="banner"> => <div className="all-sort-list"> => <div className="item"> 1st level category
  //=><H3>: (span, a) & <div className="item-list">=> <div className="subitem">:(<dl className="fore1">:dt, dd)
